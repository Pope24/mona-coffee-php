                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    $sql = "SELECT cham_cong.*,nhan_vien.Hoten AS ten_nhan_vien FROM cham_cong JOIN nhan_vien ON cham_cong.Ma_nv = nhan_vien.Ma_nv WHERE nhan_vien.Ma_nv = '$username' and Ngay LIKE '$date';";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['gio_di_lam']; ?></td>
                                                    <td><?php echo $row['gio_nghi']; ?></td>
                                                    </td>
                                                </tr>
                                            <?php }
